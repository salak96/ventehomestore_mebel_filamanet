            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-4 grid space-y-3">
                        <p><a href="/categories"
                                class="inline-flex gap-x-2 text-gray-400 hover:text-amber-400">Kategori</a></p>
                        <p><a href="/products" class="inline-flex gap-x-2 text-gray-400 hover:text-amber-400">Semua
                                Produk</a></p>
                        <p><a href="/products?featured=1"
                                class="inline-flex gap-x-2 text-gray-400 hover:text-amber-400">Produk Unggulan</a></p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-4 grid space-y-3">
                        <p><a href="/about" class="inline-flex gap-x-2 text-gray-400 hover:text-amber-400">Tentang
                                Kami</a></p>
                        <p><a href="/blog" class="inline-flex gap-x-2 text-gray-400 hover:text-amber-400">Blog</a></p>
                        <p><a href="/customers"
                                class="inline-flex gap-x-2 text-gray-400 hover:text-amber-400">Pelanggan</a></p>
                    </div>
                </div>
