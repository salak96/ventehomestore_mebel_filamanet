        ...
        <div
            ...
            <div>
                                ...
                                <div class="flex items-center justify-center space-x-2">
                                    <div class="w-8 h-8">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            class="w-6 h-6 text-teal-600 dark:text-blue-400 bi bi-truck"
                                            viewBox="0 0 16 16">
                                            <path
                ...
                <div class="flex items-center justify-start gap-4 px-4 mt-6 ">
                    ...
                    <a href="/my-orders"
                        class="w-full text-center px-4 py-2 bg-red-600 rounded-md text-white md:w-auto hover:bg-red-700">
                        View My Orders
                    </a>
                </div>
            </div>
